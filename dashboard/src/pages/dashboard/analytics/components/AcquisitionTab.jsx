              ...
              <TableBody className="text-xs">
                {filteredChannels.map((c, idx) => (
                  <TableRow key={idx} className="hover:bg-muted/40">
                    ...
                    <TableCell className="text-right font-medium">{c.sessions.toLocaleString()}</TableCell>
                    <TableCell className="text-right text-muted-foreground">{c.users.toLocaleString()}</TableCell>
                    <TableCell className="text-right text-emerald-600 dark:text-emerald-400 font-medium">{c.engagementRate}</TableCell>
                    <TableCell className="text-right text-muted-foreground">{c.bounceRate}</TableCell>
                    <TableCell className="text-right text-muted-foreground">{c.avgDuration}</TableCell>
                    <TableCell className="text-right font-medium">{c.transactions}</TableCell>
                    <TableCell className="text-right font-bold text-foreground">৳{c.revenue.toLocaleString()}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
